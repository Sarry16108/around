...
import com.example.home_around.fragments.MerchantEvaluationFragment;
import com.example.home_around.fragments.MerchantSelectFragment;
 ...
 * 服务类商家介绍
 */
public class MerchantDetailOfServiceActivity extends BaseNormalActivity implements View.OnClickListener {
    ...
    protected int getContentViewId() {
        return R.layout.activity_merchant_detail_service;
    }
    ...
    protected void initCommon() {
        ...
        adapter.addFragment(new MerchantSelectFragment());
        adapter.addFragment(new MerchantEvaluationFragment());
