...
public class DetailIntroductionPicsAdapter extends RecyclerView.Adapter<DetailIntroductionPicsAdapter.ResultHolder> {
    ...
    public DetailIntroductionPicsAdapter(Context context) {
        mContext = context;
    ...
    public ResultHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = null;
        view = LayoutInflater.from(mContext).inflate(R.layout.layout_detail_introduction_pics_item, viewGroup, false);
